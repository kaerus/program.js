...
function context(){
    var ctx, path, func, help, options = [].slice.call(arguments);
    ...
    if(func) {
        ...
        var bind = new Function("func","context",
            "return function " + path + "(){ return func.apply(context,[].slice.call(arguments)) }");
    ...
    Object.defineProperty(this[path],'$',{
        enumerable: false,
        writable: false,
        value: Function.prototype.call.bind(context,context(path))
    });
