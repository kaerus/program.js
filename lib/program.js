...
Program.$ = function(){
    ...
    if(func) {
        ...
        var fn = new Function("return function " + name + "(){ return func.apply(context,Array.prototype.slice.call(arguments)) }");
    ...
    h.forEach(function(a){
        if(typeof a === 'object'){
            ...
            if(typeof x === 'object'){
                ...
                /* show default '(value)' if existing or '*' if option is mandatory */
                z = a.hasOwnProperty("") ? ( a[""] ? '(' + a[""] + ')' : '') : '*';
            } else z = '';
