...
function helper(path) {
    ...
    var help = Program['?'](path);

    if(typeof Program.help === 'function'){
        Program.help(path,help);
    } else {
        Program.log(help);
    }    
}

Program.help = function(command,help) {
    var package = require("../package");

    Program.log(package.description + " version " + package.version);
    Program.log("Created by " + package.author.name + " <"+package.author.email+">");
    Program.log("Help:",command);
    Program.log(help);
} 
