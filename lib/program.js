...
if(global.v8debug) global.DEBUG = true;
...
Program.daemonize = function(port) {
    ...
    try {
        ...
        console.log("Failed to daemonize:", error);
        return false;
    }       
...
/* $("name","description") */
Program.$ = function(){
    var context, name, func, help, options = [].slice.call(arguments);
    ...
    if(func) {
        ...
        var bind = new Function("func","context",
            "return function " + name + "(){ return func.apply(context,[].slice.call(arguments)) }");
